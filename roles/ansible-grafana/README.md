...
`In tasks/install.yml section Import Grafana GPG signing key [Debian/Ubuntu] added proxy_env for correct work with  proxy` [apt_key module ignores global environment](https://github.com/ansible/ansible/issues/31691)
